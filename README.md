...
|            [ceno](https://github.com/scroll-tech/ceno)            |        RISC-V        | :red_circle:   |         :red_circle:     |  :red_circle:  |                |                Rust                 |               `GKR`                 | `Lookup` `Sumcheck`                                                          |                          Brakedown                                        |      Rust           |            [ceno](https://github.com/scroll-tech/ceno)            |
...
|              [risc0](https://github.com/risc0/risc0)              |        RISC-V        | :green_circle: |       :green_circle:     | :green_circle: | :green_circle: |                Rust                 |             `PLONK`                 | `Plookup`                                                                    | [DEEP-FRI & ALI](https://eprint.iacr.org/2021/582.pdf) | Rust, Solidity   |     Rust, Solidity  | [risc0](https://github.com/risc0/risc0)                           |
