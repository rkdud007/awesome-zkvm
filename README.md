...
| :---------------------------------------------------------------: | :----------------------------------: | :----------------------------------------------------------------------: | :-----------------------------------------------------------------------------------------------------------------: | :-------------: |
|  [acvm](https://github.com/noir-lang/noir/tree/master/acvm-repo)  | Agnostic (Plonkish, R1CS, AIR, etc.) |             Agnostic (Custom Gates, Plookup, Sumcheck, etc.)             | [UltraHonk, Plonky2, Groth16, etc.](https://github.com/noir-lang/awesome-noir/?tab=readme-ov-file#proving-backends) | Cairo, Solidity |
